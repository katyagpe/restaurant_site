...
<html>
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                       <ul class="nav navbar-nav">
                            ...
                            style="width: 150px;padding-top: 12px; visibility: hidden;">
  ...
  <li>
                                    <a href="<?php echo base_url(); ?>Customer_due_receive/customerDueReceives"><i class="fa fa-dashboard"></i> <span><?php echo lang('dashboard'); ?></span></a>
                                </li>
...
<?php if (in_array('Kitchen', $this->session->userdata('menu_access')) || in_array('Bar', $this->session->userdata('menu_access')) || in_array('Waiter', $this->session->userdata('menu_access'))) { ?> 
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li style="visibility:hidden; height:1px;"><a href="<?php echo base_url(); ?>Bar/panel"><i class="fa fa-angle-double-right"></i><?php echo lang('bar'); ?></a></li>
                                        <?php } ?>
                                        <?php if (in_array('Waiter', $this->session->userdata('menu_access'))) { ?> 
                                        <li style="visibility:hidden; height:1px;"><a href="<?php echo base_url(); ?>Waiter/panel"><i class="fa fa-angle-double-right"></i><?php echo lang('waiter'); ?></a></li> 
                                        <?php } ?>
                                    </ul>
                                </li>
...
<?php } ?> 
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu"> 
                                    ...
                                    <li style="visibility:hidden; height:1px; width:1px;"><a href="<?php echo base_url(); ?>Authentication/SMSSetting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i><?php echo lang('sms_setting'); ?></a></li>
