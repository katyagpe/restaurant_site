        ...
        <div class="wrapper fix">
            <div class="fix main_top">
                ...
                <div class="fix floatleft top_menu">
                    ...
                    <button id="help_button" style="visibility:hidden; height:1px; width:1px;"><i class="fas fa-question-circle"></i> <?php echo lang('help'); ?></button>
                    ...
                    <a href="<?php echo base_url(); ?>Dashboard/dashboard" id="logout_button"><i class="fas fas-caret-square-left"></i><?php echo lang('back'); ?></a>
