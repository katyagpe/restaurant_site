...
<html>
    <head>
        <title>SolucionDigital.net</title>
    ...
    <input type="hidden" id="csrf_value_" value="<?php echo $this->security->get_csrf_hash(); ?>">
                ...
                <div class="main_middle fix">
                    <div class="main_top fix">
                        <div class="button_holder fix">
                            <div class="single_button_middle_holder fix" style="width:33%;">
                                <button data-selected="unselected" style="float:left;margin-left:2px;" id="dine_in_button"><i class="fas fa-table"></i> <?php echo lang('dine'); ?> - A</button>
                          
                          
                            </div>
                            <div class="single_button_middle_holder fix" style="width:33%;">
                                <button id="take_away_button"><i class="fas fa-shopping-bag"></i> <?php echo lang('take_away'); ?> - B</button>
                            </div>
                            <div class="single_button_middle_holder fix" style="width:33%;">
                                <button data-selected="unselected" style="float:right;margin-right:2px;" id="delivery_button"><i class="fas fa-truck"></i> <?php echo lang('delivery'); ?> - C</button>
                            </div>

                        </div>
                        <div class="waiter_customer">
                            <div class="single_button_middle_holder" style="padding-left:.4%;width:45%">
                            ...
                            <div class="single_button_middle_holder" style="visibility:hidden; height:1px; width:1px;">
                                <button id="table_button"><i class="fas fa-table"></i> <?php echo lang('table'); ?>xxc</button>
                            </div>
                        </div>
                        <!-- <select>
                                <option>Table</option>
                    ...
                    <div style="position: absolute;bottom: 1px;width: 100%" id="bottom_absolute">
                        ...
                        <table cellspacing="0" cellpadding="0">
                                ...
                                <tr style="background-color:#96BB24;height: 35px;">
                                    <td></td>
        ...
        <div id="finalize_order_modal" class="modal">
            ...
            <div class="modal-content" id="modal_finalize_order_details">
                ...
                <div id="methodPay" class="fo_3 fix" style="display: none;">
                     <div class="half fix floatleft textleft"><?php echo lang('payment_cash'); ?></div>
                     <div class="half fix floatleft textright"><input class="amount_payment_mix" type="text" name="amount_payment_cash" id="amount_payment_cash"></div>

                     <div class="half fix floatleft textleft"><?php echo lang('payment_card_one'); ?></div>
                     <div class="half fix floatleft textright"><input class="amount_payment_mix" type="text" name="amount_payment_one" id="amount_payment_one"></div>

                     <div class="half fix floatleft textleft"><?php echo lang('payment_card_two'); ?></div>
                     <div class="half fix floatleft textright"><input class="amount_payment_mix" type="text" name="amount_payment_two" id="amount_payment_two"></div>

                     <div class="half fix floatleft textleft"><?php echo lang('payment_card_three'); ?></div>
                     <div class="half fix floatleft textright"><input class="amount_payment_mix" type="text" name="amount_payment_three" id="amount_payment_three"></div>
                     
                     <div class="amount_footer">
                        <div class="half fix floatleft textleft"><?php echo lang('total_pay_method');?></div>
                        <div class="half fix floatleft textright"><input type="text" name="total_amount_payMethod" id="total_amount_payMethod"></div>
                     </div>
