...
<html>
    <head>
        <meta charset="utf-8">
        <title>Factura No: <?= $sale_object->sale_no ?></title>
        ...
        <div id="wrapper">
            <div id="receiptData">
                ...
                <div id="receipt-data">
                    ...
                    <div><img src="<?php echo base_url(); ?>assets/images/chef.png" class="img-circle" alt="User Image" width="180px;"></div>
                            <!--<h3>
                    ...
                    <p>
                         Ticket No.: <?= $order_type.' '.$sale_object->sale_no ?>
                            <br>
                        Fecha: <?= date($this->session->userdata('date_format'), strtotime($sale_object->sale_date)); ?> /Hora: <?= date('H:i',strtotime($sale_object->order_time)) ?><br>
                        Restaurant: <?php echo $sale_object->user_name; ?><br>
            ...
            <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                ...
                <span class="pull-right col-xs-12">
                    <button class="btn btn-block btn-primary">LOAD xml</button> </span>
                <span class="pull-right col-xs-12">
                    <button onclick="window.print();" class="btn btn-block btn-primary">IMPRIMIR</button> </span>
               
                <span class="pull-right col-xs-12">
                    <button onclick="cerrarse();" class="btn btn-block btn-primary">Cerrar</button> </span>
