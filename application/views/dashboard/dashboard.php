      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-lime">
            ...
            <a href="<?php echo base_url(); ?>Master/foodMenus" class="small-box-footer">Gestionar<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-7">
          ...
          <div class="box-body">  
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #5CEBBD;" href="<?php echo base_url(); ?>Master/addEditFoodMenu"><span class="fa fa-book text-info"></span>+ <?php echo lang('food_menu'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #12F3AA;" href="<?php echo base_url(); ?>SupplierPayment/addSupplierPayment"><span class="fa fa-user text-info"></span>+ <?php echo lang('supplier_payment'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #0DF9AD;" href="<?php echo base_url(); ?>Sale/POS"><span class="fa fa-television text-info"></span><?php echo lang('pos'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #0CD192;" href="<?php echo base_url(); ?>Expense/addEditExpense"><span class="fa fa-money text-info"></span>+ <?php echo lang('expense'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #08B17B;" href="<?php echo base_url(); ?>Purchase/addEditPurchase"><span class="fa fa-truck text-info"></span>+ <?php echo lang('purchase'); ?></a>
            </div>
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #53F590;" href="<?php echo base_url(); ?>Report/dailySummaryReport"><span class="fa fa-list text-info"></span><?php echo lang('daily_summary_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #7DEFA8;" href="<?php echo base_url(); ?>Report/registerReport"><span class="fa fa-list text-info"></span><?php echo lang('register_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #45BA71;" href="<?php echo base_url(); ?>Report/profitLossReport"><span class="fa fa-list text-info"></span><?php echo lang('profit_loss_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #24B95C;" href="<?php echo base_url(); ?>Report/saleReportByDate"><span class="fa fa-list text-info"></span><?php echo lang('sales_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #1FDC66;" href="<?php echo base_url(); ?>Report/foodMenuSales"><span class="fa fa-list text-info"></span><?php echo lang('food_sales_report'); ?></a>              
            </div>
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #B8EACA;" href="<?php echo base_url(); ?>Short_message_service/smsService"><span class="fa fa-envelope text-info"></span><?php echo lang('send_sms'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #98D7AF;" href="<?php echo base_url(); ?>Inventory/index"><span class="fa fa-cube text-info"></span><?php echo lang('inventory'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #60C786;" href="<?php echo base_url(); ?>Inventory_adjustment/inventoryAdjustments"><span class="fa fa-adjust text-info"></span><?php echo lang('inventory_adjustment'); ?></a>
              ...
              <a class="btn icon-btn btn-info" style="background-color: #11D75A;" href="<?php echo base_url(); ?>Attendance/addEditAttendance"><span class="fa fa-clock-o text-info"></span>+ <?php echo lang('attendance'); ?></a>
            </div>             
          </div> 
        </div>
        </div> 
